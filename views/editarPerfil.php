    ...
    <div class="container">
        ...
        <div class="row mt-2">
            <div class="col-6">
                ...
                <input class="form-control" id="tipodocumento" type="text" placeholder="Tipo de documento" aria-label="default input example">
            </div>
            <div class="col-6">
        ...
        <div class="row mt-2">
            ...
            <div class="col-4">
                ...
                <input class="form-control" id="Ciudad" type="text" placeholder="Ciudad" aria-label="default input example">
            </div>
            <div class="col-4">
